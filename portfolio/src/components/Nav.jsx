    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{
            fontFamily: 'Inter, sans-serif', fontSize: 11, color: '#636366',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: '#636366' }}>
          ...
          <a
            ...
            style={{
              ...
              color: '#636366', textDecoration: 'none',
              border: '1px solid #2C2C2E', padding: '4px 10px', borderRadius: 6,
              transition: 'color 0.15s, border-color 0.15s',
            }}
            onMouseEnter={(e) => { e.currentTarget.style.color = '#F4F4F5'; e.currentTarget.style.borderColor = '#3A3A3C' }}
            onMouseLeave={(e) => { e.currentTarget.style.color = '#636366'; e.currentTarget.style.borderColor = '#2C2C2E' }}
          >
